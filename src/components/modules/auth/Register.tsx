      ...
      >
        <div className="text-center mb-8">
          ...
          <motion.h1 
            ...
            className="text-4xl font-bold bg-teal-600 bg-clip-text text-transparent mb-2"
          >
            Create Account
          </motion.h1>
          <motion.p 
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-4 py-3.5 border rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-200 bg-white/50 ${
                    validationErrors.name ? 'border-red-300 bg-red-50' : 'border-slate-200'
                  }`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full pl-12 pr-4 py-3.5 border rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-200 bg-white/50 ${
                    validationErrors.password ? 'border-red-300 bg-red-50' : 'border-slate-200'
                  }`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full pl-12 pr-4 py-3.5 border rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-200 bg-white/50 ${
                    validationErrors.confirmPassword ? 'border-red-300 bg-red-50' : 'border-slate-200'
                  }`}
            ...
            <Button
              type="submit"
              className="w-full py-3.5 text-lg font-semibold mt-6 bg-teal-600 hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-sm"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
